...
1.1 – Collaboration
Main idea: Collaboration helps people create better programs by sharing ideas, testing, and giving feedback.
Example: A group of students can work together on an app, with one person designing the layout and another person writing the code.
Reflection: I learned that collaboration can make a project stronger because different people notice different problems. I still wonder how programmers decide which idea is best when team members disagree.

1.2 – Program Function and Purpose
Main idea: Every program is created for a purpose and has specific functions to help users.
Example: A weather app helps users check the temperature, forecast, and warnings.
Reflection: I realized that good programs are not only about code, but also about solving a real problem for users. It made me think about how developers decide what features are actually necessary.

1.3 – Program Design and Development
Main idea: Programs are usually developed through planning, testing, debugging, and improving.
Example: A game developer tests a game, finds bugs, and updates the game to make it better.
Reflection: I learned that creating a program is an iterative process, not something finished perfectly the first time. I still wonder how developers know when a program is ready to publish.
